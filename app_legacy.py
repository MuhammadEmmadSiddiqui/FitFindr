...
###################### API Client Setup #######################
# SECURITY NOTE: API keys have been removed for security
# This is the legacy version - use the new version with environment variables
api_keys = [
    "your_groq_api_key_1",  # Client 1
    "your_groq_api_key_2",  # Client 2
    "your_groq_api_key_3"   # Client 3
]
